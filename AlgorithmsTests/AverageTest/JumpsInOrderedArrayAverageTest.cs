...
{
    public class JumpsInOrderedArrayAverageTest
    {
        ...
        public void Test1()
        {
            ...
            int result = Search.JumpsInOrderedArray(array, element);
        ...
        public void TestOnly1()
        {
            ...
            // вызов тестируемого алгоритма, получение результата
            int result = Search.JumpsInOrderedArray(array, 1);
        ...
        public void TestStartElement()
        {
            ...
            // вызов тестируемого алгоритма, получение результата
            int result = Search.JumpsInOrderedArray(array, 0);
            Assert.Equal(result, 0);
        }
        [Fact]
        public void TestEndElement()
        {
            ...
            // вызов тестируемого алгоритма, получение результата
            int result = Search.JumpsInOrderedArray(array, 2);
