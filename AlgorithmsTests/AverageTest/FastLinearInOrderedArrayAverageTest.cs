...
namespace AlgorithmsTests
{
    public class FastLinearInOrderedArrayAverageTest
    {
        ...
        public void TestOnly1()
        {
            ...
            // вызов тестируемого алгоритма, получение результата
            int result = Search.FastLinearInOrderedArray(array, 1);
        ...
        public void TestStartElement()
        {
            ...
            // вызов тестируемого алгоритма, получение результата
            int result = Search.FastLinearInOrderedArray(array, 0);
            Assert.Equal(result, 0);
        }
        [Fact]
        public void TestEndElement()
        {
            ...
            // вызов тестируемого алгоритма, получение результата
            int result = Search.FastLinearInOrderedArray(array, 2);
